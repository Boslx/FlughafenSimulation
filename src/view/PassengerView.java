...
public class PassengerView extends ImageView {
	 ...
	 */
	private PassengerView(String label, String image, int xPos, int yPos) {
	 ...
	 */
	public static PassengerView create(String label, String image, int xPos, int yPos) {

		return new PassengerView(label, image, xPos, yPos);
	...
	private class MyMouseListener extends MouseAdapter {
		 ...
		 */
		MyMouseListener(Component theComponent) {
