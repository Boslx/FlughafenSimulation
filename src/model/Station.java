...
public abstract class Station extends Actor {
	 ...
	 */
	Station(String label, int xPos, int yPos, String image) {
	...
	protected boolean work() {
		...
		if (numberOfOutQueueObjects() > 0) {
			...
			Passenger myObject = this.getNextOutQueueObject();//get the object
	 ...
	 */
	protected abstract Passenger getNextInQueueObject();
	 ...
	 */
	protected abstract Collection<Passenger> getNextInQueueObjects();
	 ...
	 * @return the next object or null if there's nothing found
	 */
	protected abstract Passenger getNextOutQueueObject();
	 ...
	 * @return a collection of objects or null if there's nothing found
	 */
	protected abstract Collection<Passenger> getNextOutQueueObjects();
